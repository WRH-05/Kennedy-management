...
export const teacherService = {
    ...
    ): Promise<{ data: Tables<"teachers">[]; total: number; page: number; pageSize: number } | PostgrestError> {
        try {
            let query = supabase
                .from('teachers')
    ...
    async getTeacherById(id: string): Promise<Tables<"teachers"> | PostgrestError> {
